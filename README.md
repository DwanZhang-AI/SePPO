...
Prompts are: 
(1) Photo of a pigeon in a well **tailored suit** getting a cup of coffee in a cafe in the morning; 
(2) Ginger Tabby cat **watercolor** with flowers; 
(3) An image of a peaceful mountain landscape at sunset, with **a small cabin nestled** in the trees and a winding river in the foreground; 
(4) Space dog; 
(5) b\&w photo of 42 y.o man in **white clothes**, bald, face, half body, body, high detailed skin, skin pores, **coastline**, overcast weather.
